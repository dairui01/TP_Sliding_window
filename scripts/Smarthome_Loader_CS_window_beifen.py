...
class DataGenerator_window_test(Sequence):
    ...
    def _get_data_skeleton(self, list_IDs_temp):
        ...
        # Generate data
        #f = 'Cook_p15_r03_v16_c03'
        #unpadded_file = np.load(self.path_skeleton +'P02T01C06.npz')['arr_0']
        unpadded_file = np.load('/data/stars/user/rdai/Toyota_deploy/deployment_codes1/data/3d_skeleton/Smarthomes/P03T18C03.npz')['arr_0']
